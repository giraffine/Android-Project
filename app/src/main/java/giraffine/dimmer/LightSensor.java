...
public class LightSensor implements ProximitySensor.EventCallback {
    ...
    public void updateSensitive() {
        switch (Prefs.getSpeed(Prefs.PREF_SPEED_DIM)) {
            case 1:
                mDelayEnterDark = 1000;
                break;
            case 2:
                mDelayEnterDark = 3000;
                break;
            case 3:
                mDelayEnterDark = 5000;
                break;
            case 4:
                mDelayEnterDark = 7000;
                break;
            case 5:
                mDelayEnterDark = 10000;
                break;
        }
        switch (Prefs.getSpeed(Prefs.PREF_SPEED_BRIGHT)) {
            case 1:
                ...
                break;
            case 2:
                mDelayLeaveDark = 1000;
                break;
            case 3:
                mDelayLeaveDark = 2000;
                break;
            case 4:
                mDelayLeaveDark = 5000;
                break;
            case 5:
                mDelayLeaveDark = 10000;
                break;
        }
